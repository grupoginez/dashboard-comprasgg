...
<meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' https://alcdn.msauth.net https://cdnjs.cloudflare.com; connect-src https://login.microsoftonline.com https://graph.microsoft.com; frame-src https://login.microsoftonline.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://login.microsoftonline.com;">
...
/* Table */
.tw{overflow-x:auto;overflow-y:auto;-webkit-overflow-scrolling:touch}
...
@media(max-width:600px){
  /* Header: dos filas en lugar de una */
  .hdr{height:auto;min-height:44px;padding:6px 10px;flex-wrap:wrap;row-gap:4px}
  .hdr h1{font-size:12px}
  .hdr-sub{display:none}
  .hdr-r{margin-left:0;width:100%;justify-content:flex-end;flex-wrap:wrap;gap:4px}
  .btn-hdr{padding:4px 8px;font-size:9px;gap:2px}
  .uname{max-width:80px}
  .fbadge{display:none!important}

  /* Sheet tabs: más compactas, ocultar contadores */
  .sheet-tabs{position:relative;top:auto}
  .sheet-tab{padding:8px 10px;font-size:11px}
  .sheet-tab-count{display:none}

  /* Filter bar y chips: sin sticky en móvil */
  .fbar{position:relative;top:auto;padding:8px 10px}
  .chips{position:relative;top:auto}

  /* KPI sticky: también relativo en móvil */
  #wrap-kpi{position:relative!important;top:auto!important;box-shadow:none!important}

  /* Contenido general */
  .page{padding:10px}
  .g2,.g3{grid-template-columns:1fr}
  .kpis{grid-template-columns:1fr 1fr}
  /* Evita que los items de grid se expandan más allá de su columna (min-width:auto CSS Grid default) */
  .g2>*,.g3>*,.kpis>*{min-width:0}

  /* Tablas: scroll horizontal táctil en iOS Safari */
  .tw{overflow-x:scroll;overflow-y:visible;max-height:none!important;-webkit-overflow-scrolling:touch}
...
<header class="hdr">
  ...
  <div class="hdr-r">
    ...
    <button class="btn-hdr" id="logout-btn" title="Cerrar sesión">⎋ Salir</button>
    <div class="fbadge" id="fbadge">🔍 <span id="fbadge-n">0</span> filtro(s)</div>
    <div class="sw" id="theme-sw">
      <div class="sw-t" id="sw-t"><div class="sw-th"></div></div>
      <span class="sw-lbl" id="sw-l">☀️ Claro</span>
    </div>
    <button class="btn-hdr" id="freeze-btn">📌 Fijar filtros</button>
    <button class="btn-hdr" id="reload-btn" title="Forzar recarga desde SharePoint">↺ Actualizar</button>
    <button class="btn-hdr" id="export-csv-btn">⬇ CSV</button>
  </div>
</header>

<!-- SHEET TABS -->
<div class="sheet-tabs" id="sheet-tabs">
  <button class="sheet-tab active" id="stab-MP" data-sheet="MP"><span class="sheet-tab-ico">🧪</span>Materias Primas<span class="sheet-tab-count">1,189</span></button>
  <button class="sheet-tab" id="stab-PIGMENTOS" data-sheet="PIGMENTOS"><span class="sheet-tab-ico">🎨</span>Pigmentos<span class="sheet-tab-count">122</span></button>
  <button class="sheet-tab" id="stab-FRAGANCIAS" data-sheet="FRAGANCIAS"><span class="sheet-tab-ico">🌸</span>Fragancias<span class="sheet-tab-count">7,443</span></button>
  <button class="sheet-tab" id="stab-PIPAS" data-sheet="PIPAS"><span class="sheet-tab-ico">🛢️</span>Pipas<span class="sheet-tab-count">3,723</span></button>
  <button class="sheet-tab" id="stab-OTROS" data-sheet="OTROS"><span class="sheet-tab-ico">📦</span>Otros<span class="sheet-tab-count">119</span></button>
</div>
<!-- FILTER BAR -->
<div class="fbar" id="fbar">
  <div class="fg"><div class="fg-l">📅 Año</div><div class="msr" id="msr-yr"><div class="mst" id="mst-yr" data-dd="yr"><span class="mst-tx" id="mtx-yr">Todos</span><span class="mst-ct" id="mct-yr"></span><span class="mst-ar">▼</span></div><div class="msd" id="msd-yr"></div></div></div>
  <div class="fg"><div class="fg-l">📆 Mes</div><div class="msr" id="msr-mo"><div class="mst" id="mst-mo" data-dd="mo"><span class="mst-tx" id="mtx-mo">Todos</span><span class="mst-ct" id="mct-mo"></span><span class="mst-ar">▼</span></div><div class="msd" id="msd-mo"></div></div></div>
  <div class="fg"><div class="fg-l">🏭 Proveedor</div><div class="msr" id="msr-pv"><div class="mst" id="mst-pv" data-dd="pv"><span class="mst-tx" id="mtx-pv">Todos</span><span class="mst-ct" id="mct-pv"></span><span class="mst-ar">▼</span></div><div class="msd" id="msd-pv"></div></div></div>
  <div class="fg"><div class="fg-l">📦 Materia</div><div class="msr" id="msr-pr"><div class="mst" id="mst-pr" data-dd="pr"><span class="mst-tx" id="mtx-pr">Todas</span><span class="mst-ct" id="mct-pr"></span><span class="mst-ar">▼</span></div><div class="msd" id="msd-pr"></div></div></div>
  <div class="fg">
    <div class="fg-l">💱 Moneda</div>
    <div class="cur-seg">
      <button class="cur-b active" id="cbtn-MXN" data-cur="MXN">MXN</button>
      <button class="cur-b"        id="cbtn-USD" data-cur="USD">USD</button>
      <button class="cur-b"        id="cbtn-ALL" data-cur="ALL">Ambas</button>
    </div>
  </div>
  <div class="fg">
    <div class="fg-l">🧭 Ir a sección</div>
    <div class="qnav-wrap" id="qnav-wrap">
      <div class="qnav-trigger" id="qnav-trigger">
        <span>📍 Navegar</span>
        <span class="qnav-trigger-arr" id="qnav-arr">▼</span>
      </div>
      <nav class="qnav" id="qnav">
        <div class="qnav-sec">Vista rápida</div>
        <button class="qnav-item" data-target="wrap-kpi"><span class="qnav-ico">📊</span><span class="qnav-lbl">Resumen general</span></button>
        <button class="qnav-item" data-target="wrap-s1"><span class="qnav-ico">🏆</span><span class="qnav-lbl">1. Ranking de Materias</span></button>
        <button class="qnav-item" data-target="wrap-s2"><span class="qnav-ico">📐</span><span class="qnav-lbl">2. Máximo y Mínimo</span></button>
        <button class="qnav-item" data-target="wrap-s3"><span class="qnav-ico">🏭</span><span class="qnav-lbl">3. Participación Proveedores</span></button>
        <button class="qnav-item" data-target="wrap-s4"><span class="qnav-ico">📈</span><span class="qnav-lbl">4. Evolución Proveedores</span></button>
        <button class="qnav-item" data-target="wrap-s5"><span class="qnav-ico">📦</span><span class="qnav-lbl">5. Evolución Materias</span></button>
        <button class="qnav-item" data-target="wrap-s5b"><span class="qnav-ico">💲</span><span class="qnav-lbl">5b. Precios por Material</span><span class="qnav-badge">nuevo</span></button>
        <button class="qnav-item" data-target="wrap-s6"><span class="qnav-ico">🧾</span><span class="qnav-lbl">6. Órdenes de Compra</span></button>
        <button class="qnav-item" data-target="wrap-s7"><span class="qnav-ico">📊</span><span class="qnav-lbl">7. Variación OC vs Entrega</span></button>
        <button class="qnav-item" data-target="wrap-s8"><span class="qnav-ico">⏱️</span><span class="qnav-lbl">8. Tiempos de Entrega</span></button>
        <button class="qnav-item" data-target="wrap-s9"><span class="qnav-ico">💰</span><span class="qnav-lbl">9. Análisis Económico</span></button>
      </nav>
    </div>
  </div>
  <div class="fg"><button class="btn-sm" id="reset-btn" style="margin-top:16px">↺ Limpiar</button></div>
</div>
...
<div class="sec-wrap" id="wrap-kpi" style="position:sticky;top:155px;z-index:175;background:var(--bg);padding-bottom:6px;box-shadow:0 3px 12px rgba(0,0,0,.15)">
  <div class="sec-hdr" data-sec="kpi"><span class="sec-ttl">📊 Resumen General</span><span class="sec-tog open" id="tog-kpi">▼</span></div>
  <div class="sec-body" id="body-kpi"><div class="kpis" id="kpis" style="padding-top:10px"></div></div>
</div>

<!-- §1 RANKING -->
<div class="sec-wrap" id="wrap-s1">
  <div class="sec-hdr" data-sec="s1"><span class="sec-ttl">🏆 1. Ranking de Materias Adquiridas</span><span class="sec-tog open" id="tog-s1">▼</span></div>
  <div class="sec-body" id="body-s1">
    <div class="g2" style="align-items:start;padding-top:10px">
      <div class="card">
        <div class="ch">
          ...
          <div class="ca">
            <select class="btn-sm" id="rsort-key" style="min-width:110px">
            ...
            <button class="btn-sm on" id="rsort-dir">↓ Mayor→Menor</button>
            <button class="btn-hdr" data-tbl="tbl-rank">⬇ CSV</button>
          </div>
        </div>
      ...
      <div class="card">
        <div class="ch">
          ...
          <div class="ca"><button class="btn-sm on" id="rcht">Horizontal</button></div>
        </div>
    ...
    <div class="gf card">
      <div class="ch">
        ...
        <div class="ca">
          <button class="btn-sm on" id="rimp-t">Apilado</button>
          <button class="btn-sm on" id="rimp-a">Horizontal</button>
        </div>
      </div>
...
<div class="sec-wrap" id="wrap-s2">
  <div class="sec-hdr" data-sec="s2"><span class="sec-ttl">📐 2. Consumo Máximo y Mínimo por Materia</span><span class="sec-tog open" id="tog-s2">▼</span></div>
  <div class="sec-body" id="body-s2">
    <div class="gf card" style="padding-top:10px">
      <div class="ch"><div><div class="ct">Extremos mensuales</div><div class="cs">Mayor y menor consumo · periodo · proveedor</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-mm">⬇ CSV</button></div></div>
...
<div class="sec-wrap" id="wrap-s3">
  <div class="sec-hdr" data-sec="s3"><span class="sec-ttl">🏭 3. Participación por Proveedor</span><span class="sec-tog open" id="tog-s3">▼</span></div>
  <div class="sec-body" id="body-s3" style="padding-top:10px">
    <div class="g2">
      <div class="card" style="grid-column:span 2">
        <div class="ch"><div><div class="ct">KG / LTS por proveedor — Top 15</div></div><div class="ca"><button class="btn-sm on" id="pvt">Barras</button></div></div>
...
<div class="sec-wrap" id="wrap-s4">
  <div class="sec-hdr" data-sec="s4"><span class="sec-ttl">📈 4. Evolución de Compras por Proveedor</span><span class="sec-tog open" id="tog-s4">▼</span></div>
  <div class="sec-body" id="body-s4" style="padding-top:10px">
    <div class="gf card">
      <div class="ch"><div><div class="ct">KG / LTS anuales — top 8 proveedores</div></div><div class="ca"><button class="btn-sm on" id="evt">Línea</button></div></div>
      <div style="height:290px;position:relative"><canvas id="ch-evpv"></canvas></div>
    </div>
    <div class="gf card">
      <div class="ch"><div><div class="ct">Variación anual por proveedor</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-pvyr">⬇ CSV</button></div></div>
...
<div class="sec-wrap" id="wrap-s5">
  <div class="sec-hdr" data-sec="s5"><span class="sec-ttl">📦 5. Evolución Histórica por Materia</span><span class="sec-tog open" id="tog-s5">▼</span></div>
  <div class="sec-body" id="body-s5" style="padding-top:10px">
    ...
    <div class="gf card">
      <div class="ch"><div><div class="ct">Variación anual por materia</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-pryr">⬇ CSV</button></div></div>
...
<div class="sec-wrap" id="wrap-s5b">
  <div class="sec-hdr" data-sec="s5b"><span class="sec-ttl">💲 5b. Comportamiento de Precios por Material</span><span class="sec-tog open" id="tog-s5b">▼</span></div>
  <div class="sec-body" id="body-s5b" style="padding-top:10px">
    <div class="gf card">
      <div class="ch">
        ...
        <div class="ca">
          <div class="msr" id="msr-pm"><div class="mst" id="mst-pm" data-dd="pm" style="min-width:140px"><span class="mst-tx" id="mtx-pm">Top 5 materias</span><span class="mst-ct" id="mct-pm"></span><span class="mst-ar">▼</span></div><div class="msd" id="msd-pm"></div></div>
        </div>
      </div>
    ...
    <!-- Stats table -->
    <div class="gf card">
      <div class="ch"><div><div class="ct">Estadísticas de precio por material</div><div class="cs">PRECIO UNITARIO sin IVA · Mín · Máx · Prom ponderado · Variación %</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-price">⬇ CSV</button></div></div>
      <div class="tw" style="max-height:320px"><table id="tbl-price"></table></div>
    </div>
    <!-- Annual variation -->
    <div class="gf card">
      <div class="ch"><div><div class="ct">Precio promedio anual por material — variación %</div><div class="cs">Precio unitario promedio ponderado por cantidad entregada</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-price-yr">⬇ CSV</button></div></div>
...
<div class="sec-wrap" id="wrap-s6">
  <div class="sec-hdr" data-sec="s6"><span class="sec-ttl">🧾 6. Órdenes de Compra</span><span class="sec-tog open" id="tog-s6">▼</span></div>
  <div class="sec-body" id="body-s6" style="padding-top:10px">
    <div class="kpis" id="kpis-fo"></div>
    <div class="gf card">
      <div class="ch"><div><div class="ct">Suma de importe e importe promedio por periodo</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-fo">⬇ CSV</button></div></div>
...
<div class="sec-wrap" id="wrap-s7">
  <div class="sec-hdr" data-sec="s7"><span class="sec-ttl">📊 7. Variación OC vs Entrega (Cumplimiento)</span><span class="sec-tog open" id="tog-s7">▼</span></div>
  <div class="sec-body" id="body-s7" style="padding-top:10px">
    ...
    <div class="gf card">
      <div class="ch">
        ...
        <div class="ca">
          <button class="det-btn" id="det-btn">▶ Ver detalle de OC</button>
          <button class="btn-hdr" data-tbl="tbl-vsum">⬇ CSV</button>
        </div>
      </div>
      <div class="tw" style="max-height:300px"><table id="tbl-vsum"></table></div>
      <div class="det-pane" id="det-pane">
        <div style="font-size:10px;color:var(--text3);font-weight:700;text-transform:uppercase;letter-spacing:.4px;margin-bottom:7px;display:flex;align-items:center;justify-content:space-between"><span>Detalle por Orden de Compra</span><button class="btn-hdr" data-tbl="tbl-vdet">⬇ CSV</button></div>
...
<div class="sec-wrap" id="wrap-s8">
  <div class="sec-hdr" data-sec="s8"><span class="sec-ttl">⏱️ 8. Variación de Tiempo de Entrega</span><span class="sec-tog open" id="tog-s8">▼</span></div>
...
<div class="sec-wrap" id="wrap-s9">
  <div class="sec-hdr" data-sec="s9"><span class="sec-ttl">💰 9. Análisis Económico</span><span class="sec-tog open" id="tog-s9">▼</span></div>
  <div class="sec-body" id="body-s9" style="padding-top:10px">
    ...
    <div class="gf card">
      <div class="ch"><div><div class="ct">Tabla económica por materia</div><div class="cs">MXN original · USD original · sin conversión · ambos registros visibles si aplica</div></div><div class="ca"><button class="btn-hdr" data-tbl="tbl-eco">⬇ CSV</button></div></div>
